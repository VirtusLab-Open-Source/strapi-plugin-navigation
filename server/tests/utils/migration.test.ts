...
import {
    removeNavigationsWithoutDefaultLocale
} from '../../src/utils';
    ...
    describe('Utils', () => {
        describe('Migration', () => {
            ...
            it('should handle error when getDefaultLocale fails', async () => {
                ...
                // When & Then
                await expect(
                    removeNavigationsWithoutDefaultLocale({ strapi: mockStrapi })
                ).rejects.toThrow('Failed to get default locale');
                expect(mockRepository.find).toHaveBeenCalled();
                expect(mockRepository.remove).not.toHaveBeenCalled();
            });
            ...
            it('should handle error when find fails', async () => {
                ...
                await expect(
                    removeNavigationsWithoutDefaultLocale({ strapi: mockStrapi })
                ).rejects.toThrow('Failed to find navigations');
                expect(mockRepository.remove).not.toHaveBeenCalled();
            });
        });
    });
