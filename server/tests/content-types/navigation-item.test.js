...
const lifecycles_1 = __importDefault(require("../../src/content-types/navigation-item/lifecycles"));
const schema_1 = __importDefault(require("../../src/content-types/navigation-item/schema"));
describe('Navigation', () => {
    describe('Server', () => {
