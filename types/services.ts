...
import { ExtendedNavigationConfig, NavigationConfig, NavigationRawConfig, NavigationSettingsConfig } from "./config";
...
export interface IAdminService {
  config: (viaSettingsPage?: boolean) => Promise<NavigationSettingsConfig | NavigationConfig & ExtendedNavigationConfig>,
  ...
  updateConfig: (newConfig: NavigationConfig) => Promise<void>,
...
export interface ICommonService {
  ...
  setDefaultConfig: () => Promise<NavigationRawConfig>,
...
export interface IClientService {
  ...
  renderRFR: (input: { items: NestedStructure<NavigationItem>[], parent?: Id | null, parentNavItem?: RFRNavItem | null, enabledCustomFieldsNames: string[] }) => ToBeFixed,
