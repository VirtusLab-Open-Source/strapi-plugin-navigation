const fr = {
  ...
  popup: {
    ...
    item: {
      ...
      form: {
        ...
        uiRouter: {
          unableToRender:
            "Impossible de générer le slug ou la clé du routeur d'interface utilisateur en raison de caractères non pris en charge",
        },
        path: {
          label: 'URL',
  ...
  notification: {
    navigation: {
      ...
      error:
        'Chemin en double : « { path } » dans le parent : « { parentTitle } » pour { errorTitles } éléments',
      item: {
  ...
  pages: {
    ...
    settings: {
      ...
      form: {
        ...
        overviewUi: {
          label: 'Nouvelle interface de navigation',
          hint: "Active la nouvelle interface avec une vue d'ensemble et des pages de détail",
        },
        ...
        nameField: {
          ...
          label: 'Champs de nom',
          placeholder:
            'Sélectionner au moins un ou laisser vide pour appliquer les valeurs par défaut',
        ...
        populate: {
          ...
          placeholder:
            'Sélectionner au moins un ou laisser vide pour désactiver le remplissage des champs de relation',
        ...
        contentTypesSettings: {
          ...
          initializationWarning: {
            title: 'Avertissement',
            content:
              "- Le type de contenu n'a pas encore été initialisé. Initialisez-le d'abord pour pouvoir l'utiliser dans un éditeur visuel.",
          },
        },
        customFields: {
          table: {
            confirmation: {
              ...
              message:
                'Cette action entraînera la suppression de toutes les valeurs des champs personnalisés des éléments de navigation.',
              confirm: 'Continuer',
          ...
          popup: {
            ...
            type: {
              ...
              description:
                'Le type de champ personnalisé détermine le type de données que le champ peut contenir',
            },
            required: {
              label: 'Champ requis',
              description:
      ...
      actions: {
        ...
        restore: {
          ...
          confirmation: {
            ...
            confirm: 'Restaurer',
            description:
              'La configuration du plugin sera restaurée à partir du fichier plugins.js.',
          },
          description:
            "La restauration de la configuration du plugin entraînera son remplacement par la configuration enregistrée dans le fichier 'plugins.js'.",
        },
        restart: {
          ...
          alert: {
            ...
            description:
              'Vous avez apporté des modifications à la configuration qui nécessitent le redémarrage de votre application Strapi pour prendre effet. Faites-le manuellement ou en utilisant le déclencheur ci-dessous.',
            close: 'Ignorer',
            cancel: 'Annuler',
            reason: {
              ...
              I18N_NAVIGATIONS_PRUNE:
                'Les navigations dans des locales obsolètes seront supprimées.',
            },
          },
        },
        disableI18n: {
          confirmation: {
            ...
            description: {
              line1:
                "Vous désactivez l'internationalisation pour la navigation. Les navigations pour les locales différentes de la locale par défaut ne sont pas disponibles pour la visualisation et les modifications via ce plugin.",
