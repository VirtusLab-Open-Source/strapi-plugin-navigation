                    ...
                    <Box {...BOX_DEFAULT_PROPS} width="100%">
                      <RestartAlert
                        closeLabel={formatMessage(
                          getTrad('pages.settings.actions.restart.alert.cancel')
                        )}
                      ...
                      >
                        <>
                          <Box paddingBottom={1}>
                            {formatMessage(
                              getTrad('pages.settings.actions.restart.alert.description')
                            )}
                          </Box>
                              ...
                              >
                                <Toggle
                                  ...
                                  onChange={(eventOrPath: FormChangeEvent) =>
                                    handleChange(
                                      eventOrPath,
                                      !values.preferCustomContentTypes,
                                      onChange
                                    )
                                  }
                                            ...
                                            <Grid.Item col={12} s={12} xs={12}>
                                              ...
                                              >
                                                <MultiSelect
                                                  ...
                                                  value={get(
                                                    values,
                                                    `contentTypesNameFields[${index}].fields`
                                                  )}
                                                  onChange={(value: Array<string>) => {
                                                    const updated = get(
                                                      values,
                                            ...
                                            <Grid.Item col={12} s={12} xs={12}>
                                              ...
                                              >
                                                <MultiSelect
                                                  ...
                                                  value={get(
                                                    values,
                                                    `contentTypesPopulate[${index - 1}].fields`,
                                                    []
                                                  )}
                                                  onChange={(value: Array<string>) => {
                                                    const updated = get(
                                            ...
                                            <Grid.Item col={12} s={12} xs={12}>
                                              ...
                                              >
                                                <MultiSelect
                                                  ...
                                                  value={get(
                                                    values,
                                                    `pathDefaultFields[${index - 1}].fields`,
                                                    []
                                                  )}
                                                  onChange={(value: Array<string>) => {
                                                    const updated = get(
                      ...
                      <Grid.Root gap={4} width="100%">
                        <Grid.Item col={4} s={12} xs={12}>
                          <Box width="100%">
                            <Field
                              name="allowedLevels"
                              label={formatMessage(
                                getTrad('pages.settings.form.allowedLevels.label')
                              )}
                              hint={formatMessage(
                                getTrad('pages.settings.form.allowedLevels.hint')
                              )}
                            >
                              <NumberInput
                                width="100%"
                        ...
                        <Grid.Item col={4} s={12} xs={12}>
                          <Field
                            ...
                            hint={formatMessage(
                              getTrad('pages.settings.form.cascadeMenuAttached.hint')
                            )}
                          >
                            <Toggle
                              width="100%"
